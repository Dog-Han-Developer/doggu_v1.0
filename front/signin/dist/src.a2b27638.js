...
},{"./page-not-found.template":"src/page/page-not-found.template.js"}],"src/page/signup.template.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"src/page/utils/index.js":[function(require,module,exports) {
"use strict";
...
exports.nextTick = nextTick;
},{}],"src/page/views/text-field.template.js":[function(require,module,exports) {
"use strict";
...
var _default = window.Handlebars.compile(template);

exports.default = _default;
},{}],"src/page/views/text-field.js":[function(require,module,exports) {
"use strict";
...
class TextField {
  ...
  #attachEventHandler = () => {
    ...
    (_document$querySelect = document.querySelector(this.#container)) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.addEventListener('change', this.#onChange);
  };
  #update = () => {
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./text-field":"src/page/views/text-field.js"}],"src/page/signup.js":[function(require,module,exports) {
"use strict";
...
var _signup = _interopRequireDefault(require("./signup.template"));
...
class Signup {
  ...
  #initialize = () => {
    ...
    const passwordField = new _views.TextField('#required-fields', {
      id: 'password',
      label: '비밀번호',
...
function router() {
  ...
  switch (path) {
    ...
    case '#/signup':
      const signup = new _signup.default('#root', {
        store
      });
      signup.render();
      break;
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "14331" + '/');
